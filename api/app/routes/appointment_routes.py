...
from api.app.resources.appointment import AppointmentAvailabilityGETResource, AppointmentAvailabilityPOSTResource, AppointmentAvailabilityResource, AppointmentBookingResource
